(function () {
  ...
  function standardRightDeck() {
    ...
    right.innerHTML = '<div class="gw-shell-fader"><span>FLUX</span><div class="hw-fader-track-horizontal gw-shell-fader-track"><div class="hw-fader-glow-bar" style="width:78%"></div><div class="hw-fader-thumb-3d" style="left:78%"></div></div><span class="text-[#dfc384]">78%</span></div><div class="gw-shell-fader"><span>VRAM</span><div class="hw-fader-track-horizontal gw-shell-fader-track"><div class="hw-fader-glow-bar" style="width:62%;background:linear-gradient(90deg,#38bdf8,#2dd4bf)"></div><div class="hw-fader-thumb-3d" style="left:62%"></div></div><span class="text-cyan-300">14.8G</span></div><span class="h-4 w-px bg-white/10"></span><span class="text-[9px] font-mono text-slate-400">PRE</span><div class="hw-slide-toggle active" aria-label="PRE/POST"><div class="hw-slide-peg"></div></div><span class="text-[9px] font-mono text-[#dfc384]">POST</span><span class="h-4 w-px bg-white/10"></span><a id="topbarUnifiedTrashBtn" class="gw-shell-trash" href="projects.html?openTrash=1" onclick="if(window.V2Projects?.openGlobalTrashDrawer){event.preventDefault();window.V2Projects.openGlobalTrashDrawer();}" title="统一回收站" aria-label="打开统一回收站"><span class="hw-mini-knob"><span class="hw-mini-knob-arc" style="border-top-color:#ef4444;border-right-color:#f59e0b"></span><span class="hw-mini-knob-inner"><i data-lucide="trash-2" class="w-3.5 h-3.5"></i></span></span><span id="topbarTrashBadge" class="gw-shell-trash-badge" hidden>0</span></a><div class="h-4 w-px bg-white/10"></div><div class="hw-avatar-keycap" title="当前登录席位：admin"><div class="hw-avatar-keycap-inner"><i data-lucide="shield-check" class="w-4 h-4 text-[#eddab3]"></i></div><span class="hw-avatar-keycap-status"></span></div>';
