  ...
  updateUIFromSelection() {
    ...
    if (this.selectionType === "audio" && seg) {
      ...
      this.audioInfoArea.innerHTML = `
        File: <span>${escapeHtml(seg.fileName || "Unknown")}</span><br>
    ...
    if (isImage) {
      ...
      openBtn.onclick = () => {
        ...
        if (win) {
          ...
          doc.body.style.cssText = "margin:0;display:flex;justify-content:center;align-items:center;background:#0e0e0e;height:100vh;";
          const image = doc.createElement("img");
          image.style.cssText = "max-width:100%;max-height:100%;";
          image.src = String(seg.imageB64 || "");
