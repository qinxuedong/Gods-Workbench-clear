...
- [~] T11 `main.py` 拆分进行中 —— Phase B（`9e1b0fe2`）、Phase C 首批（`368ae249`）、Phase D 首批（`d737f944`）、Phase D 第 2–4 批（`352a5f06`/`4ed27afb`/`3ea0e65d`，合计 37/60 符号）已提交；余 23 符号属必须后置或显式注入类，后续滚动 Phase D 余下 - Phase G
