...
- [x] T6 最终验收审核 + 复审确认 —— 见 `FINAL-ACCEPTANCE-AUDIT` / `FINAL-ACCEPTANCE-REVERIFY`（2026-09-18）
...
- [~] T11 `main.py` 拆分进行中（Phase B–D 首批已提交，43/60 符号）—— 详见 `docs/governance/TASK-NOTES-2026-09-18.md` §9
- [ ] T12（P1，破坏性操作，待用户确认）清理 `.git` 内 16 个 Copilot checkpoint 引用（含 13 个独占二进制 blob）—— 详见 `TASK-NOTES-2026-09-18.md` §2
- [ ] T13 旧集成标记卫生用例基线重定（当前唯一失败项）—— 待裁决，详见 `TASK-NOTES-2026-09-18.md` §4
